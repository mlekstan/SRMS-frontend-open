export default function RentSignal({ width, height, fill }: { width: string, height: string, fill: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={width} height={height} fill={fill}>
