...
import { itemsTableColumns } from '../../../-components/tables/items-table-columns';
  ...
  errorComponent: ({ error, reset }) => {
    ...
    return (
      <FailureDialog 
        ...
        closeFn={() => {
          reset();
          goBack(router, canGoBack, "/manage/items/create");
        }}
        duration={null}
    ...
    <>
      {
        ...
        <FormPaperContainer>
          ...
          <CustomTable 
            ...
            onRowClick={(row) => navigate({ to: "/manage/items/view/$itemId", params: { itemId: row.id } })}
            />
        </FormPaperContainer>
      }
